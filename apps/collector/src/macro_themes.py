...
THEMES: dict[str, dict] = {
    "AI반도체/HBM":     {
        "kw": ["반도체", "hbm", "ai 메모리", "엔비디아", "nvidia", "gpu", "파운드리", "d램", "삼성전자", "sk하이닉스", "마이크론", "micron", "데이터센터", "컴퓨팅", "tscm", "암드", "amd"],
        "basket": ["000660", "005930", "042700", "000990", "058470"],
    },
    "전자부품/AI기판": {
        "kw": ["mlcc", "기판", "fc-bga", "pcb", "적층세라믹", "패키징", "fc bga", "삼성전기", "lg이노텍", "대덕전자", "이수페타시스", "온디바이스", "애플", "아이폰", "갤럭시", "socamm2", "심텍", "코리아써키트", "주성엔지니어링", "어드밴스드 패키징", "유리기판"],
        "basket": ["009150", "011070", "090460", "029460", "222800", "007810", "036930"],
    },
    "내수소비/유통/명품": {
        "kw": ["백화점", "명품", "유통", "관광", "면세", "뷰티", "화장품", "외식", "한류", "외국인 소비", "지갑", "신세계", "현대백화점", "이마트", "쿠팡", "올리브영"],
        "basket": ["004170", "023530", "069960", "008770", "031430", "007310", "278470", "139480"],
    },
    "음식료/수출소비재": {
        "kw": ["음식료", "라면", "K-푸드", "수출", "삼양식품", "농심", "오리온", "불닭", "빙그레", "담배", "인삼", "해외 매출", "미국 마트"],
        "basket": ["003230", "004370", "271560", "005180", "033780"],
    },
    "조선/방산": {
        "kw": ["조선", "방산", "선박", "lng운반", "엔진", "함정", "잠수함", "해양플랜트", "한화오션", "삼성중공업", "hd현대", "현대로템", "lig넥스원", "k-방산", "우주항공", "위성"],
        "basket": ["329180", "010140", "042660", "012450", "064350"],
    },
    "바이오/제약": {
        "kw": ["바이오", "제약", "임상", "fda", "신약", "치료제", "항체", "지방간염", "비만약", "삼성바이오", "셀트리온", "유한양행", "한미약품", "기술수출", "glp-1"],
        "basket": ["006280", "069620", "347850", "007390", "068270"],
    },
    "2차전지/ESS": {
        "kw": ["2차전지", "배터리", "ess", "양극재", "리튬", "캐즘", "전기차", "ev", "lg엔솔", "에코프로", "포스코퓨처엠", "삼성sdi", "sk이노베이션", "테슬라", "관세", "ira"],
        "basket": ["373220", "051910", "006400", "247540"],
    },
    "금융/밸류업": {
        "kw": ["밸류업", "배당", "은행", "증권", "보험", "금융지주", "저pbr", "자사주", "주주환원", "kb금융", "신한지주", "메리츠", "삼성화재", "거래소"],
        "basket": ["032830", "005940", "105560", "138040"],
    },
    "로봇/피지컬AI": {
        "kw": ["로봇", "피지컬ai", "피지컬 ai", "휴머노이드", "자율주행", "레인보우", "두산로보틱스", "협동로봇", "스마트팩토리", "자동화"],
        "basket": ["307950", "012330", "108490", "056080"],
    },
    "원전/전력": {
        "kw": ["원전", "전력", "송전", "변압기", "전기기기", "송배전", "퓨얼셀", "소형원전", "smr", "두산에너빌리티", "hd현대일렉트릭", "ls일렉트릭", "효성중공업", "체코", "전력망"],
        "basket": ["052690", "051600", "015760", "336260"],
    },
    "통신/인프라/디지털": {
        "kw": ["통신", "5g", "6g", "데이터센터", "클라우드", "소프트웨어", "보안", "sk텔레콤", "kt", "네이버", "카카오", "it서비스"],
        "basket": ["017670", "030200", "035420", "035720"],
    },
}
